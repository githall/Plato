    ...
    public class FollowTypes : IFollowTypeProvider
    {
        ...
        public static readonly FollowType Label =
            new FollowType(
                "DocLabel",
                "Follow Label",
                "Follow this label to get notified when new docs are posted with this label",
                "Unsubscribe",
                "You are following this label and will be notified when docs are posted with this label, click to unsubscribe",
