...
namespace Plato.Attachments.Services
{
    ...
    public class AttachmentViewIncrementer : IAttachmentViewIncrementer<Attachment>
    {
        ...
        public IAttachmentViewIncrementer<Attachment> Contextulize(HttpContext context)
        {
            _context = context;
            return this;
        }

        public async Task<Attachment> IncrementAsync(Attachment attachment)
        {
        ...
        async Task UpdateTotalViewsAsync(Attachment attachment)
        {
            // Sql query
