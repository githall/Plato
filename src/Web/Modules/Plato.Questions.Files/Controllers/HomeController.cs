            ...
            var entities = await _entityService
                .ConfigureQuery(async q =>
                {
                    ...
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Questions.Permissions.ViewPrivateQuestions))
                    {
                        q.HidePrivate.True();
                    }
                    ...
                    // Hide hidden?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Questions.Permissions.ViewHiddenQuestions))
                    {
                        q.HideHidden.True();
                    }
                    ...
                    // Hide spam?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Questions.Permissions.ViewSpamQuestions))
                    {
                        q.HideSpam.True();
                    }
                    ...
                    // Hide deleted?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Questions.Permissions.ViewDeletedQuestions))
                    {
                        q.HideDeleted.True();
                    }
