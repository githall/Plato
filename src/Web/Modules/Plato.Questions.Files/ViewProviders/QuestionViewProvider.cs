...
namespace Plato.Questions.Files.ViewProviders
{

    public class QuestionViewProvider : ViewProviderBase<Question>
    {
        // Get current feature
        public const string ModuleId = "Plato.Questions.Files";
        ...
        public override async Task<IViewProviderResult> BuildEditAsync(Question entity, IViewProviderContext context)
        {
            ...
            return Views(
                View<EntityFileOptions>("Files.Edit.Sidebar", model =>
                {
                    ...
                    model.PostPermission = Permissions.PostQuestionFiles;
                    model.DeleteOwnPermission = Permissions.DeleteOwnQuestionFiles;
                    model.DeleteAnyPermission = Permissions.DeleteAnyQuestionFiles;
        ...
        public override async Task<IViewProviderResult> BuildUpdateAsync(Question article, IViewProviderContext updater)
        {
