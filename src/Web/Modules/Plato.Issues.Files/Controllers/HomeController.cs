...
namespace Plato.Issues.Files.Controllers
{
            ...
            var entities = await _entityService
                .ConfigureQuery(async q =>
                {
                    ...
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Issues.Permissions.ViewPrivateIssues))
                    {
                        q.HidePrivate.True();
                    }
                    ...
                    // Hide hidden?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Issues.Permissions.ViewHiddenIssues))
                    {
                        q.HideHidden.True();
                    }
                    ...
                    // Hide spam?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Issues.Permissions.ViewSpamIssues))
                    {
                        q.HideSpam.True();
                    }
                    ...
                    // Hide deleted?
                    if (!await _authorizationService.AuthorizeAsync(HttpContext.User,
                        Issues.Permissions.ViewDeletedIssues))
                    {
                        q.HideDeleted.True();
                    }
