...
namespace Plato.Issues.Files.ViewProviders
{
    ...
    {
        // Get current feature
        public const string ModuleId = "Plato.Issues.Files";
        ...
        public override async Task<IViewProviderResult> BuildEditAsync(Issue entity, IViewProviderContext context)
        {
            ...
            return Views(
                View<EntityFileOptions>("Files.Edit.Sidebar", model =>
                {
                    ...
                    model.PostPermission = Permissions.PostIssueFiles;
                    model.DeleteOwnPermission = Permissions.DeleteOwnIssueFiles;
                    model.DeleteAnyPermission = Permissions.DeleteAnyIssueFile;
        ...
        public override async Task<IViewProviderResult> BuildUpdateAsync(Issue article, IViewProviderContext updater)
        {
