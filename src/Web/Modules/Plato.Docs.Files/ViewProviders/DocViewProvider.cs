...
namespace Plato.Docs.Files.ViewProviders
{
    ...
    public class DocViewProvider : ViewProviderBase<Doc>
    {
        ...
        public override Task<IViewProviderResult> BuildDisplayAsync(Doc entity, IViewProviderContext updater)
        {
            return Task.FromResult(default(IViewProviderResult));
        }
        ...
        public override async Task<IViewProviderResult> BuildEditAsync(Doc entity, IViewProviderContext context)
        {
            ...
            return Views(
                View<EntityFileOptions>("Files.Edit.Sidebar", model =>
                {
                    ...
                    model.DeleteAnyPermission = Permissions.DeleteAnyDocFile;
