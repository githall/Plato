...
namespace Plato.Tenants.SignUp.Services
{
    ...
    public class SignUpManager : ISignUpManager<Models.SignUp>
    {
        ...
        public async Task<ICommandResult<Models.SignUp>> UpdateAsync(Models.SignUp model)
        {
            var result = new CommandResult<Models.SignUp>();
            ...
            foreach (var handler in _broker.Pub<Models.SignUp>(this, "SignUpUpdating"))
            {
                model = await handler.Invoke(new Message<Models.SignUp>(model, this));
            }
            ...
            if (signUp != null)
            {
                ...
                foreach (var handler in _broker.Pub<Models.SignUp>(this, "SignUpUpdated"))
                {
                    model = await handler.Invoke(new Message<Models.SignUp>(model, this));
                }
        ...
        public async Task<ICommandResult<Models.SignUp>> DeleteAsync(Models.SignUp model)
        {
            ...
            foreach (var handler in _broker.Pub<Models.SignUp>(this, "SignUpDeleting"))
            {
                signUp = await handler.Invoke(new Message<Models.SignUp>(signUp, this));
            }
            ...
            if (success)
            {
                ...
                foreach (var handler in _broker.Pub<Models.SignUp>(this, "SignUpDeleted"))
                {
                    signUp = await handler.Invoke(new Message<Models.SignUp>(signUp, this));
                }
