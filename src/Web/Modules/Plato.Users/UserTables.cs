...
namespace Plato.Users
{
    public static class UserTables
    {
        ...
        public static readonly SchemaTable Users = new SchemaTable()
        {
            Name = "Users",
        ...
        public static readonly SchemaTable UserPhoto = new SchemaTable()
        {
            Name = "UserPhoto",
            Columns = new List<SchemaColumn>()
                {
        ...
        public static readonly SchemaTable UserBanner = new SchemaTable()
        {
            Name = "UserBanner",
            Columns = new List<SchemaColumn>()
                {
        ...
        public static readonly SchemaTable UserData = new SchemaTable()
        {
            Name = "UserData",
            Columns = new List<SchemaColumn>()
            {
        ...
        public static readonly SchemaTable UserLogin = new SchemaTable()
        {
            Name = "UserLogins",
            Columns = new List<SchemaColumn>()
            {
