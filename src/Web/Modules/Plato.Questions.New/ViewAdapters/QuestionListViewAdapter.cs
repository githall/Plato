...
namespace Plato.Questions.New.ViewAdapters
{
    ...
    public class QuestionListViewAdapter : ViewAdapterProviderBase
    {   

        public IHtmlLocalizer T { get; }

        public QuestionListViewAdapter(IHtmlLocalizer<QuestionListItemViewAdapter> localizer)
        {

            T = localizer;
            ViewName = "QuestionList";
        ...
        public override async Task<IViewAdapterResult> ConfigureAsync(string viewName)
        {
            ...
            {
                v.AdaptModel<EntityIndexViewModel<Question>>(model =>
                {
