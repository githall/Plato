...
namespace Plato.Ideas.Files.ViewProviders
{
    ...
    public class IdeaViewProvider : ViewProviderBase<Idea>
    {
        ...
        public override async Task<IViewProviderResult> BuildEditAsync(Idea entity, IViewProviderContext context)
        {
            ...
            return Views(
                View<EntityFileOptions>("Files.Edit.Sidebar", model =>
                {
                    ...
                    model.PostPermission = Permissions.PostIdeaFiles;
                    model.DeleteOwnPermission = Permissions.DeleteOwnIdeaFiles;
                    model.DeleteAnyPermission = Permissions.DeleteAnyIdeaFile;
        ...
        public override async Task<IViewProviderResult> BuildUpdateAsync(Idea article, IViewProviderContext updater)
        {
